...
class Mal_Sub extends JFrame implements ActionListener, KeyListener, FocusListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == tf_korean) { // �ѱ� �Է¶��� �ѱ��� �Է��� �Ŀ� ���͸� ġ��.. ��Ŀ����
											// �ѱ��(��ġ ��Űó��)
			tf_english.requestFocus();
		} else if (e.getSource() == tf_english) {// ������� ������ �Է��� �Ŀ� ���͸� ġ��..
													// ��Ŀ���� �ѱ��(��ġ ��Űó��)
	...
	public void focusGained(FocusEvent e) {
		if (e.getSource() == tf_korean) {
			try {
				InputContext inCtx2 = tf_korean.getInputContext(); // comp�� text
																	// component
			...
			try {
				InputContext inCtx = tf_korean.getInputContext(); // comp�� text
																	// component
				Character.Subset[] subset = null;
				inCtx.setCharacterSubsets(subset);
			} catch (Exception ee) {
